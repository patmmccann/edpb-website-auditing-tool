...
@Component({
    ...
    imports: [MatButtonModule, MatSort, MatSortHeader, MatIconModule, AsyncPipe, TranslateModule, FilterForStatus, FilterForCookie, FilterForCookieKnowledge, SafeHtmlPipe, FindPurpose]
})
